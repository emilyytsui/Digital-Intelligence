...
def sierpinski(degree, p1, p2, p3, color, line_width, screen):
    draw_triangle(p1, p2, p3, color, line_width + 1, screen)

    if degree > 0:
        new_p1 = find_midpoint(p1, p2)
        new_p2 = find_midpoint(p2, p3)
        new_p3 = find_midpoint(p3, p1)
        
        #sierpinski(degree - 1, p1, new_p1, new_p3, color, line_width, screen)
        sierpinski(degree - 1, p1, new_p1, new_p3, RED, line_width, screen)
        #sierpinski(degree - 1, p2, new_p1, new_p2, color, line_width, screen)
        sierpinski(degree - 1, p2, new_p1, new_p2, BLUE, line_width, screen)
        #sierpinski(degree - 1, p3, new_p2, new_p3, color, line_width, screen)
        sierpinski(degree - 1, p3, new_p2, new_p3, GREEN, line_width, screen)
